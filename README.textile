...
I assume that you already have a Rails 3.1 Spree application up and running. If not, the "Spree Documentation":http://spreecommerce.com/documentation will help you getting started.

To make use of @spree_digital@, you need to add this line to your @Gemfile@:

<pre>
  gem 'spree_digital', :git => 'git://github.com/sammyd/spree_digital.git', :branch => 'master'
</pre>

@spree_digital@ is a generator, to install it:

<pre>
  rails g spree_digital:install
</pre>

The generator will ask whether to run the migrations. If you don't do it now then ensure that you run it before starting the application:
...
<img src="http://github.com/sammyd/spree_digital/raw/master/doc/tables.png">
...
<pre>
  ...
  git clone git://github.com/sammyd/spree_digital
</pre>
...
See "http://github.com/sammyd/spree_digital/blob/master/LICENSE":LICENSE